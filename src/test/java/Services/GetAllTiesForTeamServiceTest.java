 ...
 * @author slett
 */
public class GetAllTiesForTeamServiceTest {
    ...
    public void testConstructor() {
        try {
            new GetAllTiesForTeamService(null);
            fail();
        } catch (ServiceException e) {

        }
        new GetAllTiesForTeamService(1L);
    }

    @Test
    public void testInit() {
        GetAllTiesForTeamService service = new GetAllTiesForTeamService(1L);
        try {
