 ...
 * @author Simon
 */
public class AddPeriodResultToGameServiceIT {
    ...
    public AddPeriodResultToGameServiceIT() {
    }
    ...
    public void testExecute() {
         ...
         Integer[] homeScores = {0, 1, 2};
         Integer[] awayScores = {3, 4, 5};
         AddPeriodResultsToGameService add;
         add = new AddPeriodResultsToGameService(homeScores, awayScores, gameId);
