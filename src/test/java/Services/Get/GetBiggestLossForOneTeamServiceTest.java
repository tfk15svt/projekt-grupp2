 ...
 * @author ntn13aae
 */
public class GetBiggestLossForOneTeamServiceTest {
    ...
    public void testConstructor() {
        try {
            new GetBiggestLossForOneTeamService(null, startDate, endDate);
            fail();
        } catch (ServiceException e) {
        }
        try {
            new GetBiggestLossForOneTeamService(1L, null, endDate);
            fail();
        } catch (ServiceException e) {
        }
        try {
            new GetBiggestLossForOneTeamService(1L, startDate, null);
            fail();
        } catch (ServiceException e) {
        }
        new GetBiggestLossForOneTeamService(1L, startDate, endDate);
    }

    @Test
    public void testInit() {
        GetBiggestLossForOneTeamService service = new GetBiggestLossForOneTeamService(1L, startDate, endDate);
        try {
