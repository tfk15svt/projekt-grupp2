 ...
 * @author slett
 */
public class GetAllLossesForTeamServiceTest {
    ...
    public void testConstructor() {
        try {
            new GetAllLossesForTeamService(null);
            fail();
        } catch (ServiceException e) {

        }
        new GetAllLossesForTeamService(1L);
    }

    @Test
    public void testInit() {
        GetAllLossesForTeamService service = new GetAllLossesForTeamService(1L);
        try {
