...
public class ShowTableWithDynamicFiltersServiceTest {
    ...
    public static void setUpClass() {
        ...
        when(serviceBroker.getAllGamesFromSeasonService(seasonIds)).thenReturn(getAllGamesFromSeasonService);
        when(getAllGamesFromSeasonService.execute()).thenReturn(allSeasonGames);
        when(seasonBroker.getAllTeamsFromSeasonId(seasonIds)).thenReturn(allSeasonTeams);
    ...
    public void testConstructor1() {
        ...
        new ShowTableWithDynamicFiltersService(seasonIds);
    }
    ...
    public void testConstructor2() {
        ...
        new ShowTableWithDynamicFiltersService(leagueId);
    }
    ...
    public void testInit() {
        ShowSeasonTableService instance = new ShowSeasonTableService(seasonIds);
        try {
            instance.init(null);
        } catch (ServiceException e) {
        }
